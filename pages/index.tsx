...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: "    name: 'Bhuwan Garg',", type: 'array-item' },
    { code: "    role: 'Data Scientist',", type: 'array-item' },
    { code: "    bio: 'passionate Data Scientist'", type: 'array-item' },
    { code: '  };', type: 'array-end' },
    { code: '', type: 'blank' },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <h1 className={styles.developerName}>
            Bhuwan <span className={styles.accentText}>Garg</span>
          </h1>

          <div className={styles.developerRole}>Data Scientist</div>

          <p className={styles.bio}>
          Passionate Data Scientist with expertise in extracting insights from complex datasets to drive strategic decision-making. Skilled in machine learning, statistical analysis, and data storytelling to deliver impactful business solutions.
          </p>
          ...
          <div className={styles.actionLinks} style={{ display: 'flex', gap: '1rem' }}>
            ...
            <a
              href="https://www.canva.com/design/DAGhbjEeWn4/QJ6LCXFlXSAEJkQreUeoKg/view?utm_content=DAGhbjEeWn4&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=he44fea454f"
              target="_blank"
